##----------------------------------
##  This real data code for self-paced learning with L1 penalty embeded in the Ensemble-based framework.
##  Ensemble_SPL
##  Code Version 1.0
...
## 2.1 Colon dataset
#-------------------
cat("Starting colon dataset.\n", sep = "")
ensemblePanels <- lapply(colon_train_data, function(i){
  cvfit_ensem <- selfpaced.EN.single(X_train = i, 
                                     Y_train = as.numeric(colon_train_lable),
...
## 2.2 gbm dataset
#-----------------
cat("Starting GBM dataset.\n", sep = "")
ensemblePanels <- lapply(gbm_train_data, function(i){
  cvfit_ensem <- selfpaced.EN.single(X_train = i, 
                                     Y_train = as.numeric(gbm_train_lable),
                                     lambda = sample.select,
                                     uplambda = sample.add,
                                     Iter_num = Iter_num)
})
...
## 2.3 Kidney dataset
#--------------------
cat("Starting Kidney dataset.\n", sep = "")
ensemblePanels <- lapply(kidney_train_data, function(i){
  cvfit_ensem <- selfpaced.EN.single(X_train = i, 
                                     Y_train = as.numeric(kidney_train_lable),
                                     lambda = sample.select,
                                     uplambda = sample.add,
                                     Iter_num = Iter_num)
})
...
## 2.4 Lung dataset
#----------------
cat("Starting Lung dataset.\n", sep = "")
ensemblePanels <- lapply(lung_train_data, function(i){
  cvfit_ensem <- selfpaced.EN.single(X_train = i, 
                                     Y_train = as.numeric(lung_train_lable),
                                     lambda = sample.select,
                                     uplambda = sample.add,
                                     Iter_num = Iter_num)
})
